...
export async function GET(_req, { params }) {
  const [order] = await sql`SELECT o.code, o.status, o.type, o.total_cents, o.created_at, o.scheduled_for, o.pay_method, o.paid_online, r.name AS restaurant_name, r.color
